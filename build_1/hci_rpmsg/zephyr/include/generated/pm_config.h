...
#define PM__NVS_STORAGE_OFFSET 0x0
#define PM__NVS_STORAGE_ADDRESS 0x0
#define PM__NVS_STORAGE_END_ADDRESS 0x800000
#define PM__NVS_STORAGE_SIZE 0x800000
#define PM__NVS_STORAGE_NAME nvs_storage
#define PM__NVS_STORAGE_ID 0
#define PM__nvs_storage_ID PM_NVS_STORAGE_ID
#define PM__nvs_storage_IS_ENABLED 1
#define PM_0_LABEL _NVS_STORAGE
#define PM__NVS_STORAGE_DEV DT_CHOSEN(nordic_pm_ext_flash)
#define PM__NVS_STORAGE_DEFAULT_DRIVER_KCONFIG CONFIG_PM_EXTERNAL_FLASH_HAS_DRIVER
...
#define PM__NUM 6
#define PM__ALL_BY_SIZE "external_flash otp tfm tfm_sram sram_secure tfm_secure rpmsg_nrf53_sram sram_primary sram_nonsecure app tfm_nonsecure nvs_storage"
