...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 12000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 247);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_NVS_STORAGE, 0x800000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_REGION_NVS_STORAGE_EXTERNAL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UBXLIB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UBXLIB_CELL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UBXLIB_GNSS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UBXLIB_SHORTRANGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_UBXLIB_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_SX12XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_NRF_UARTE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_ENHANCED_POLL_OUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_NRF_TX_BUFFER_SIZE, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORAWAN_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORAWAN_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORAWAN_SYSTEM_MAX_RX_ERROR, 200);
